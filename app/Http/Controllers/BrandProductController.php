...
class BrandProductController extends Controller
{
    ...
    public function all_brand_product(){
    	...
    	$all_brand_product = DB::table('tbl_brand')->paginate(2); //static huong doi tuong
    ...
    //End Function Admin Page
     ...
     public function show_brand_home( $brand_id){
        ...
        $brand_by_id = DB::table('tbl_product')->join('tbl_brand','tbl_product.brand_id','=','tbl_brand.brand_id')->get();
